...
Write-ColorOutput "  Project: subagent_test_env" "Blue"
Write-ColorOutput "=======================================================" "Blue"
Write-Host ""
...
try {
    ...
    if ($startApp -eq 'y' -or $startApp -eq 'Y') {
        ...
        Write-ColorOutput "  Starting: python main.py" "Yellow"
        Start-Process -FilePath "pwsh" -ArgumentList "-Command", "python main.py" -WindowStyle Hidden
